  ...
  <div class="detail-page">
    ...
    <div class="detail-header">
      <div class="detail-header-left">
        ...
        <a-tag :color="STATUS_COLOR[detail.filingStatus]" style="margin-left:10px">
        ...
        <span class="detail-header-meta">
          ...
          <span class="detail-header-meta-item">{{ PROJECT_TYPE_LABEL[detail.projectType] }}</span>
          <span class="detail-header-meta-divider" />
          <span class="detail-header-meta-item">{{ props.policyType === 'nonstandard' ? '非标政策' : '标准政策' }}</span>
          <span class="detail-header-meta-divider" />
          <span class="detail-header-meta-item">{{ detail.stationNo }}</span>
        </span>
      </div>
      <a-space>
        <a-popconfirm
          ...
          >
            ...
            <a-tab-pane key="survey" tab="勘察">
              <div class="tab-body">
                ...
                <div class="info-section">
                  ...
                  <div class="photo-readonly-grid">
                    <div v-for="cat in PHOTO_CATEGORIES" :key="cat.key" class="photo-readonly-row">
            ...
            <a-tab-pane key="design" tab="设计">
              <div class="tab-body tab-body--design">
                ...
                <div class="info-section">
                  <div class="info-section-title">乙供中/低压 BOM</div>
...
const STATUS_LABEL: Record<string, string> = {
  filing: '建档中', pending_review: '建档待审核', rejected: '建档商务审核不通过', approved: '审核通过',
}
...
.detail-title { font-size: 16px; font-weight: 600; margin-left: 4px; }
.detail-header-meta { display: flex; align-items: center; margin-left: 12px; gap: 0; }
...
/* ── 勘察照片只读 ── */
.photo-readonly-grid { display: flex; flex-direction: column; gap: 12px; margin-bottom: 8px; }
.photo-readonly-row { display: flex; align-items: flex-start; gap: 12px; }
.photo-readonly-label { width: 72px; flex-shrink: 0; font-size: 14px; color: #595959; padding-top: 4px; }
...
/* ── 流转日志 ── */
.log-card { background: #fff; border-radius: 8px; padding: 20px 20px 0; height: 100%; overflow-y: auto; box-sizing: border-box; scrollbar-width: thin; scrollbar-color: rgba(0,0,0,0.15) transparent; }
.log-card::-webkit-scrollbar { width: 4px; }
.log-card::-webkit-scrollbar-track { background: transparent; }
.log-card::-webkit-scrollbar-thumb { background: rgba(0,0,0,0.15); border-radius: 4px; }
